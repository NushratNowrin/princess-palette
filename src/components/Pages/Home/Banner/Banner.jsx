			...
			<div className=' carousel w-full h-96 bg-center bg-cover'>
				...
				<div id='slide2' className='carousel-item relative w-full'>
					...
					<div className='absolute flex justify-between items-center transform left-0 right-0 top-0 bottom-0 bg-black bg-opacity-60'>
						...
						<div className="text-center">
							<div className='font-semibold text-white font-serif tracking-wide md:text-3xl text-xl'>
								Buy the best Makeup palette <br />
								for your princess !!!
							</div>
                            <div className="h-20">
                            <button className="bg-neutral-300 text-black font-semibold px-5 py-3 rounded-md mt-5 hover:text-xl ease-in-out duration-75">Buy Now</button>
                            </div>
						</div>
